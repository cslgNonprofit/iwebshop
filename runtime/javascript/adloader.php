 ...
 * <code>
 * 	<script language="javascript" src="<?php echo IUrl::creatUrl("/javascript/adloader/");?>"></script>
 * 	<div id="adDiv">广告......</div>
...
function adLoader()
{
	...
	{
		var url="<?php echo IUrl::creatUrl("/site/ad_position_info/");?>";
	...
	{
		var url="<?php echo IUrl::creatUrl("/site/ad_list/");?>";
	...
	this.display=function(adDataKey)
	{
		...
		switch( parseInt(ad['type']) )
		{
			case 1:
				...
				code=code.replace(/{URL}/g,"<?php echo IUrl::creatUrl("");?>"+ad.content);
				break;
			case 2:
